...
public class MovilPrueba {
	...
	public void testEsAliado() {
		...
		assertTrue(movil.esAliadoDe(aliado));
		assertFalse(movil.esAliadoDe(enemigo));
		assertFalse(enemigo.esAliadoDe(aliado));
	}

	@Test
	public void testDesplazar1() {
		movil.desplazarEn(new Point(10, -2));
	...
	public void testDesplazar2() {
		movil.desplazarEn(new Point(-1.5, -2.8));
